...
export default function Appbar() {
    return (
        <div className='fixed bottom-5 left-1/2 transform -translate-x-1/2 rounded-lg w-fit max-w-1/4 min-h-12 h-fit text-black flex items-center text-[25px] px-5 border border-black justify-center'>
